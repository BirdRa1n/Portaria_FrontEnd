    ...
    <NativeBaseProvider>
            ...
            <HStack space={3}>
              ...
              <Center>
                <Button
                  shadow={1}
                  onPress={() =>
                    alert("Login por assinatura digital está desabilitado")
                  }
                  w={75}
                  h={51}
                  bg={"green.500"}
                  colorScheme={"green"}
                  startIcon={<AntDesign name="user" size={40} color="black" />}
                ></Button>
                <Text>AD</Text>
              </Center>
            </HStack>
      ...
      <Box w={"100%"} h={"100%"} safeArea justifyContent="space-between">
        ...
        <Box w={"100%"}>
          ...
          <Center>
            <Link href="https://github.com/birdra1n">
              Desenvolvido por BirdRa1n e inhagop2
            </Link>
          </Center>
        </Box>
      </Box>
