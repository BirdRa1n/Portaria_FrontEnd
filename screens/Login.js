    ...
    return (
        <NativeBaseProvider>
            <Actionsheet isOpen={isOpen} onClose={onClose} >
                <Actionsheet.Content>
                    ...
                    <Center marginTop={1}>
                        <HStack space={3}>
                            <Center>
                                <Button shadow={1} onPress={() => setShowModalQR(true)} w={75} h={51} bg={'green.500'} colorScheme={'green'} startIcon={<AntDesign name="qrcode" size={40} color="black" />}></Button>
                                <Text> QRCode</Text>
                            </Center>
                            <Center>
            ...
            <Box w={'100%'} h={'100%'} safeArea justifyContent="space-between">
                ...
                <Center>
                    <Modal isOpen={showModalQR} onClose={() => setShowModalQR(false)}>
                        <Modal.Content maxWidth="400px">
                            <Modal.CloseButton />
                            <Modal.Header>QRCode</Modal.Header>
                            <Modal.Body>
                                <Center>
                                    <BarCodeScanner
                ...
                <Box w={'100%'}>
                    ...
                    <Center>
                        <Link href="https://github.com/birdra1n">Desenvolvido por BirdRa1n e inhagop2</Link>
                    </Center>
                </Box>
            </Box>
        </NativeBaseProvider>
